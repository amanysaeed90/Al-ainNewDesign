...
open class TMBarView<Layout: TMBarLayout, Button: TMBarButton, Indicator: TMLineBarIndicator>: UIView, TMTransitionStyleable, TMBarLayoutParent {
    ...
    public let backgroundView = TMBarBackgroundView(style: .flat(color: UIColor.white))
...
//        backgroundView.
        //backgroundView.addshadow(top: false, left: false, bottom: true, right: false, shadowRadius: 2.0)
