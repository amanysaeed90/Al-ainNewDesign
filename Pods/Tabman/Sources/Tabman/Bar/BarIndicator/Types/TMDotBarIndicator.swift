...
open class TMDotBarIndicator: TMBarIndicator {
    ...
    open override var tintColor: UIColor! {
        didSet {
            dotLayer.fillColor = #colorLiteral(red: 0.6304669976, green: 0.1317067742, blue: 0.2488542497, alpha: 1).cgColor
        }
    }
    ...
    open override func layout(in view: UIView) {
        ...
        dotLayer.fillColor = #colorLiteral(red: 0.03137254902, green: 0.4, blue: 0.3294117647, alpha: 1).cgColor
