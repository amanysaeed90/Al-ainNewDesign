...
public class SheetViewController: UIViewController {
    ...
    private var containerSize: SheetSize = .fullScreen
    /// The current actual container size
    private var actualContainerSize: SheetSize = .fullScreen
    /// The array of sizes we are trying to pin to when resizing the sheet. To set, use `setSizes` function
    private var orderedSheetSizes: [SheetSize] = [.fullScreen, .fullScreen]
