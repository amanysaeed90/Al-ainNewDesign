...
open class VideoSplashViewController: UIViewController {
    ...
    open var backgroundColor = UIColor.clear { didSet { view.backgroundColor = backgroundColor } }
    ...
    override open func viewDidAppear(_ animated: Bool) {
        ...
        moviePlayer.view.backgroundColor = #colorLiteral(red: 0.1324785352, green: 0.1329619884, blue: 0.2865845561, alpha: 1)
        
        // Image
        let imageView = UIImageView(image: UIImage(named: "ScreenShoot"))
        imageView.contentMode = .scaleAspectFill
        imageView.frame = moviePlayer.view.frame
