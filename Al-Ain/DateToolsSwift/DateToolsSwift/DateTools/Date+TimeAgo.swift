...
public extension Date {
    ...
    public func timeAgo(since date:Date, numericDates: Bool = false, numericTimes: Bool = false) -> String {
        ...
        if (components.year! >= 2) {
            return String(format: "%d years ago".localized(), components.year!)
        }
            ...
            return String(format: "%d months ago".localized(), components.month!)
        }
            ...
            return String(format: "%d weeks ago".localized(), components.weekOfYear!)
        }
            ...
            return "from2days".localized()
        }
        else if (components.day! > 2) {
            return String(format: "%d days ago".localized(), components.day!)
        }
        else if (isYesterday) {
            if (numericDates) {
            ...
            return String(format: "%d hours ago".localized(), components.hour!)
        }
        else if (components.hour! == 2) {
            return "from2hours".localized()
        }
            ...
            return String(format: "%d minutes ago".localized(), components.minute!)
            }
